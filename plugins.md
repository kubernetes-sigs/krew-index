...
[cert-manager](https://github.com/jetstack/cert-manager) | Manage cert-manager resources inside your cluster | ![GitHub stars](https://img.shields.io/github/stars/jetstack/cert-manager.svg?label=stars&logo=github)
...
[datadog](https://github.com/DataDog/datadog-operator) | Manage the Datadog Operator | ![GitHub stars](https://img.shields.io/github/stars/DataDog/datadog-operator.svg?label=stars&logo=github)
...
[emit-event](https://github.com/rajatjindal/kubectl-emit-event) | Emit Kubernetes Events for the requested object | ![GitHub stars](https://img.shields.io/github/stars/rajatjindal/kubectl-emit-event.svg?label=stars&logo=github)
...
[example](https://github.com/seredot/kubectl-example) | Prints out example manifest YAMLs | ![GitHub stars](https://img.shields.io/github/stars/seredot/kubectl-example.svg?label=stars&logo=github)
...
[fuzzy](https://github.com/d-kuro/kubectl-fuzzy) | Fuzzy and partial string search for kubectl | ![GitHub stars](https://img.shields.io/github/stars/d-kuro/kubectl-fuzzy.svg?label=stars&logo=github)
...
[ipick](https://github.com/similarweb/kubectl-ipick) | A kubectl wrapper for interactive resource selection. | ![GitHub stars](https://img.shields.io/github/stars/similarweb/kubectl-ipick.svg?label=stars&logo=github)
...
[krew](https://krew.sigs.k8s.io/) | Package manager for kubectl plugins. | ![GitHub stars](https://img.shields.io/github/stars/kubernetes-sigs/krew.svg?label=stars&logo=github)
...
[kyverno](https://github.com/nirmata/kyverno) | Kyverno is a policy engine for kubernetes | ![GitHub stars](https://img.shields.io/github/stars/nirmata/kyverno.svg?label=stars&logo=github)
...
[operator](https://github.com/operator-framework/kubectl-operator) | Manage operators with Operator Lifecycle Manager | ![GitHub stars](https://img.shields.io/github/stars/operator-framework/kubectl-operator.svg?label=stars&logo=github)
[oulogin](https://github.com/TremoloSecurity/kubectl-login) | Login to a cluster via OpenUnison | ![GitHub stars](https://img.shields.io/github/stars/TremoloSecurity/kubectl-login.svg?label=stars&logo=github)
...
[podevents](https://github.com/alecjacobs5401/kubectl-podevents) | Show events for pods | ![GitHub stars](https://img.shields.io/github/stars/alecjacobs5401/kubectl-podevents.svg?label=stars&logo=github)
...
[sick-pods](https://github.com/alecjacobs5401/kubectl-sick-pods) | Find and debug Pods that are "Not Ready" | ![GitHub stars](https://img.shields.io/github/stars/alecjacobs5401/kubectl-sick-pods.svg?label=stars&logo=github)
...
[split-yaml](https://github.com/nathforge/kubectl-split-yaml) | Split YAML output into one file per resource. | ![GitHub stars](https://img.shields.io/github/stars/nathforge/kubectl-split-yaml.svg?label=stars&logo=github)
...
[starboard](https://github.com/aquasecurity/starboard) | Toolkit for finding risks in kubernetes resources | ![GitHub stars](https://img.shields.io/github/stars/aquasecurity/starboard.svg?label=stars&logo=github)
...
[trace](https://github.com/iovisor/kubectl-trace) | bpftrace programs in a cluster | ![GitHub stars](https://img.shields.io/github/stars/iovisor/kubectl-trace.svg?label=stars&logo=github)
